export const LISTENING = [
  {
    ...
    tip: 'In multi-speaker tasks, each speaker usually has one distinct viewpoint. Listen for strong feelings — words like "hate", "love", "wish" — and contrast words like "but" or "however" that signal a shift in opinion. Remember: "None" is correct only if none of the three speakers clearly expresses the stated view.',
    qs: [
      { q: 'Which speaker suggests that being in a crowd with loud music sometimes spoils their experience?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 2, explain: 'Speaker C says something like "sometimes ruins it for me" when describing their discomfort with loud crowds. The word "sometimes" is key — it matches the phrase "sometimes spoils".' },
      { q: 'Which speaker says concert tickets and extras cost too much?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 0, explain: 'Speaker A specifically complains about the cost of attending concerts, including extras like food and merchandise. Listen for negative language about money or prices.' },
      { q: 'Which speaker mentions that smaller concerts give you a more enjoyable experience than large ones?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 1, explain: 'Speaker B expresses a clear preference for smaller, more intimate gigs over large events — they feel more personal and enjoyable.' },
      { q: 'Which speaker hates when the crowd starts pushing each other?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 1, explain: 'Speaker B mentions disliking aggressive crowd behaviour like pushing. Listen for strong negative emotion about the physical experience of being in a crowd.' },
      { q: 'Who says attending concerts is one of the best ways to show your love for artists that you like?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 2, explain: 'Speaker C describes going to concerts as one of the most meaningful ways to show appreciation and support for artists you love.' },
      { q: "Which speaker thinks the sound isn't as good at a concert compared to recorded music?", opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 0, explain: 'Speaker A compares live sound quality unfavourably to studio recordings. Listen for a complaint about audio or sound at concerts versus recorded tracks.' },
      { q: 'Which speaker says that compared to single-artist concerts, festivals offer a more engaging diversity of musical acts?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 3, explain: 'None of the three speakers directly compares festivals to single-artist concerts in terms of musical diversity. When no speaker makes the specific point stated, the answer is "None".' },
      { q: 'Which speaker complains that many people spend too much time recording the show instead of enjoying it?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 1, explain: 'Speaker B complains about audiences using phones to film rather than being fully present. Listen for frustration about people not experiencing the show in the moment.' },
    ],
  },
  {
    id: 'l2',
    ...
    tip: 'In interview-style dialogues, track who says what — the interviewer and guest often disagree. Pay attention to hedging language like "I suppose", "it seems" or "I\'m not sure" — these signal uncertainty rather than strong agreement.',
    qs: [
      { q: 'How does the presenter travel?', opts: ['She prefers driving', 'She prefers cycling', 'She prefers walking', 'She prefers staying home'], a: 2, explain: 'Emma (the presenter) mentions that she prefers walking rather than cycling. Listen for how she personally gets around — she is not a cyclist.' },
      { q: 'What does the research say about traditional helmets?', opts: ['They look strange', 'They are hard to carry', 'They are uncomfortable', 'They are unsafe'], a: 1, explain: 'The research cited says traditional helmets are awkward to transport or carry around — being "hard to carry" is the key finding, not that they are unsafe or uncomfortable.' },
      { q: 'What does Emma suggest about the aH-1?', opts: ['It is too complex', 'It is too expensive', 'It is not necessary', 'It is not useful'], a: 0, explain: 'Emma questions whether the inflatable helmet design is unnecessarily complicated. Her sceptical tone throughout signals the "too complex" answer.' },
      { q: 'How does Colin compare the aH-1 to normal helmets?', opts: ['They are generally safer', 'They are generally more expensive', 'They are generally lighter', 'They are generally more comfortable'], a: 1, explain: 'Colin acknowledges the aH-1 costs more than a standard rigid helmet, even if it has advantages in portability.' },
      { q: 'Colin suggests the aH-1 will be widely adopted.', opts: ['True', 'False', 'Not mentioned'], a: 2, explain: 'Colin does not make a prediction about how widely the aH-1 will be adopted — this is simply not discussed. When a specific claim is not made, the answer is "Not mentioned".' },
      { q: 'The aH-1 is better for the environment than a rigid helmet.', opts: ['True', 'False', 'Not mentioned'], a: 0, explain: 'The dialogue confirms the aH-1 has environmental advantages over rigid helmets. This is stated directly in the conversation.' },
      { q: 'How does Emma feel about the aH-1?', opts: ['Openly doubtful', 'Somewhat undecided', 'Largely unconcerned', 'Cautiously impressed'], a: 1, explain: 'Emma\'s responses show mixed feelings throughout — she has doubts but isn\'t fully negative. "Somewhat undecided" best captures this balanced, uncertain tone.' },
      { q: 'What is the radio show about?', opts: ['Cycling and safety', 'Cycling and sports', 'Cycling and business', 'Cycling and work'], a: 0, explain: 'The programme is focused on a cycling safety product — the inflatable helmet. The topic is cycling and safety, not sports performance or business.' },
    ],
  },
  {
    id: 'l3',
    ...
    tip: 'Listen carefully for time references (seasons, holidays), reasons things changed, and how each speaker feels about their tradition. Traditions "changing" is very different from "ending" — listen for the exact relationship the speaker has with their tradition today.',
    qs: [
      { q: 'Which speaker talks about a tradition when the weather is cold?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 2, explain: 'Speaker C describes a tradition linked to cold weather or a winter season. Listen for temperature words, seasonal references, or mentions of cold conditions.' },
      { q: 'Which speaker says the tradition all started by accident?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 0, explain: 'Speaker A explains that their tradition was not planned — it began unintentionally. Listen for phrases like "by accident", "it just happened", or "without planning to".' },
      { q: 'Which speaker understands that their tradition might seem unusual to other people?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 0, explain: 'Speaker A shows self-awareness that their tradition could look strange to outsiders. Listen for acknowledgement of how others might react or perceive the tradition.' },
      { q: 'Which speaker says the tradition changed because someone now lives in another place?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 2, explain: 'Speaker C mentions their tradition adapted because a family member moved away or relocated. Listen for references to distance, moving, or living in a different location.' },
      { q: 'Which speaker says they maintain their tradition but in shorter form than it once was?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 1, explain: 'Speaker B says they still keep the tradition but in a condensed or simplified version compared to before. Listen for words like "shorter", "less", or "not as long as it used to be".' },
      { q: 'Which speaker says their tradition is an opportunity for time away from daily obligations?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 1, explain: 'Speaker B describes the tradition as a break from regular responsibilities. Listen for language about escaping routine, stepping away from work, or taking a pause from daily life.' },
      { q: 'Which speaker says the tradition is the beginning of a time of year?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 2, explain: 'Speaker C says their tradition marks the start of a particular season or annual period. Listen for phrases like "starts the year", "beginning of", or marking the arrival of a season.' },
      { q: 'Which speaker has food that resembles something important to their tradition?', opts: ['Speaker A', 'Speaker B', 'Speaker C', 'None'], a: 0, explain: 'Speaker A mentions food that is shaped or themed around something central to their tradition — it is symbolic rather than just something they eat.' },
    ],
  },
  {
    id: 'l4',
    ...
    tip: 'In monologue tasks, follow the speaker\'s personal story — what they did, why they changed, and what happened as a result. Be especially careful with "Not mentioned" — if a topic is never discussed, it is not the answer, even if it seems logical.',
    qs: [
      { q: 'What does the speaker drink in the evenings?', opts: ['Coffee', 'Tea', 'Wine', 'Water'], a: 2, explain: 'The speaker mentions drinking wine in the evenings, which contrasts with their daytime efforts to drink more water. Listen for what they drink specifically at night.' },
      { q: 'What was the main reason the speaker started drinking more water?', opts: ['Advice from friends', 'Listening to podcasts', 'The warm weather', 'Feeling tired'], a: 0, explain: 'Friends encouraged the speaker to increase their water intake. Social influence — not weather, podcasts, or tiredness — was the trigger for the change.' },
      { q: 'How does the speaker feel about drinking tea?', opts: ['They drink too much compared to coffee', 'They feel it is healthier than coffee', 'They think it is not as useful as water', 'They think tea makes them thirsty'], a: 2, explain: 'The speaker acknowledges tea is fine, but considers it less hydrating or beneficial than plain water. The comparison is between tea and water, not tea and coffee.' },
      { q: 'The speaker mentions how water made them feel less tired after a walk.', opts: ['True', 'False', 'Not mentioned'], a: 0, explain: 'The speaker explicitly says that drinking more water helped them feel less tired during or after walking. This is directly stated — it is True.' },
      { q: 'The speaker warns about drinking too many energy drinks.', opts: ['True', 'False', 'Not mentioned'], a: 2, explain: 'Energy drinks are never discussed in this monologue. Do not assume a warning was given just because the topic seems related — if it is not mentioned, the answer is "Not mentioned".' },
      { q: 'What advice does the speaker give?', opts: ['Listen to your body', 'Check the weather', 'Drink energy drinks', 'Avoid coffee'], a: 0, explain: 'The speaker\'s key recommendation is to pay attention to your own body\'s signals about thirst and energy levels, rather than following a strict rule.' },
      { q: "What best describes the speaker's overall experience?", opts: ["Small changes don't give big results", 'Habits are often difficult to change', 'Not all habits are bad', 'Small changes can be meaningful'], a: 3, explain: 'The speaker\'s journey shows that a small, simple change to their water intake led to real improvements. The overall message is that small changes can have meaningful effects.' },
      { q: 'What is the audio about?', opts: ['Getting exercise', 'Doing work', 'Playing sports', 'Drinking water'], a: 3, explain: 'The entire monologue is a personal account of improving hydration habits. The topic is drinking more water, not exercise or sport.' },
    ],
  },
  {
    id: 'l5',
    ...
    tip: 'In two-speaker dialogues, keep track of who expresses each view — Amy and Brandon may have different opinions. Inference questions ask what is implied, not just stated. "True/False/Not Given" requires the exact claim to be confirmed or contradicted — do not guess from context.',
    qs: [
      { q: 'What is the main issue Amy opens up the conversation with?', opts: ['Frustration over grocery prices', 'Lack of recipe ideas', 'Difficulty finding time to cook', 'Disappointment over quality of food'], a: 0, explain: 'Amy opens with frustration about grocery prices — the cost of food is the immediate issue she raises. Listen for negative emotion about money at the start of the conversation.' },
      { q: 'How did Brandon characterize trying to cook with only Canadian ingredients?', opts: ['It was overwhelming and frustrating', 'It was a straightforward process', 'It was pleasant but lacked ingredients', 'It was easy once he learned the stores'], a: 0, explain: 'Brandon describes the experience of cooking with only local Canadian ingredients as difficult and overwhelming — not easy or enjoyable. Listen for his tone when he describes the process.' },
      { q: 'What can be inferred about food labeling practices?', opts: ['They are completely transparent', 'They can be misleading to consumers', 'They reassure buyers about their selection', 'They ensure consistency across products'], a: 1, explain: 'The speakers discuss how food labels do not always make the origin clearly understandable — this implies labelling can mislead or confuse consumers about where their food comes from.' },
      { q: 'The speaker made a soup last week.', opts: ['True', 'False', 'Not Given'], a: 1, explain: 'This is False — the speaker mentioned making a stew or another dish, not a soup. Listen very carefully for the specific food mentioned — the question changes one word to test your attention.' },
      { q: 'What can be implied about the mention of lemons throughout?', opts: ['Farmers must try to grow citrus locally', 'Imported produce is generally superior', 'Speakers should eat more locally sourced fruit', 'Living without common imported foods is unrealistic'], a: 3, explain: 'Lemons keep coming up because they cannot be grown locally in Canada — this implies it is genuinely impossible to avoid imported produce entirely, making strict local eating unrealistic.' },
      { q: 'Food grown in greenhouses tastes bad.', opts: ['True', 'False', 'Not Given'], a: 1, explain: 'This is False — the speakers may question whether greenhouse produce counts as "local", but they do not say it tastes bad. Be careful not to confuse a debate about origin with a complaint about taste.' },
      { q: 'How does Brandon describe the pace of change needed for local food systems?', opts: ['The transformation is too ambitious', 'Change will be immediate once people realize its benefits', 'It will happen rapidly due to food supply problems', 'People will need time to adapt to new habits'], a: 3, explain: 'Brandon suggests the shift to local food systems will be gradual — people need time to adapt their shopping and cooking habits. He is realistic rather than optimistic about speed of change.' },
      { q: 'What is the main issue discussed in the conversation?', opts: ['The difficulty of affording groceries', 'The challenge of eating locally sourced food in a globalized system', 'The environmental impact of food packaging', 'The rise of a new dietary trend in Canada'], a: 1, explain: 'The whole conversation explores how difficult it is to eat locally when most food is globally sourced. The central theme is the tension between wanting to eat locally and living in a globalised food system.' },
    ],
  },
  {
    id: 'l6',
    ...
    tip: 'Historical monologues contain sequences of events, names and reasons. Focus on WHY things happened, not just what happened. For True/False/Not mentioned, be careful — a statement that sounds plausible but is never actually said is "Not mentioned", not "True".',
    qs: [
      { q: 'Eliza Scidmore was the first person to plant cherry trees in the US.', opts: ['True', 'False', 'Not mentioned'], a: 1, explain: 'This is False — Eliza Scidmore campaigned for cherry trees to be planted in Washington DC but was not the first person to actually plant them. David Fairchild planted them in his own garden earlier.' },
      { q: 'Why did David Fairchild first decide to plant cherry trees in his garden?', opts: ['He thought the trees would have economic value', 'He was likely inspired by their beauty after seeing them in Japan', "He wanted to share Japan's culture with the US", 'To encourage the government to plant the trees'], a: 1, explain: 'Fairchild was most likely motivated by the beauty of cherry blossoms he had seen in Japan. The reason is aesthetic inspiration, not economic or cultural diplomacy.' },
      { q: 'Why were cherry trees considered a good addition to Washington DC?', opts: ['They would make the city look better', 'They would provide fruit for people in the city', 'They would help prevent flooding from the Potomac River', 'They would boost tourist numbers'], a: 0, explain: 'Cherry trees were chosen to beautify the area around the Potomac River Tidal Basin — making the city look more attractive was the key reason stated.' },
      { q: 'Why did the Japanese government first send cherry trees to Washington DC?', opts: ["To fulfil Fairchild's order for his town", 'To replace American trees that were dying', 'To establish a friendly relationship with the US', 'To promote Japanese culture abroad'], a: 2, explain: 'Japan sent the trees as a diplomatic gesture — a symbol of goodwill to strengthen friendship with the United States. It was a political gift, not a response to a commercial order.' },
      { q: 'Why did Japan send a second shipment of cherry trees?', opts: ['To send a larger quantity', 'To correct the quality issues of the first shipment', 'To introduce a different variety', 'To replace trees which were stolen'], a: 1, explain: 'The first shipment was found to be diseased or of poor quality, so Japan sent a second, healthy replacement. The reason was quality, not quantity or variety.' },
      { q: 'Who planted the first cherry tree in Washington DC?', opts: ['David Fairchild', "A Japanese politician's wife", 'The president of the US', "The US president's wife"], a: 3, explain: 'The First Lady (the US president\'s wife) planted the first official cherry tree in Washington DC. This is a key detail — listen for who actually did the planting at the ceremony.' },
      { q: 'Cherry trees often live for about 50 years.', opts: ['True', 'False', 'Not mentioned'], a: 1, explain: 'This is False — cherry trees typically live much longer than 50 years, or the specific figure mentioned in the audio does not match 50. Check what lifespan is actually stated.' },
      { q: 'What is the talk about?', opts: ['How cherry trees arrived in the US', 'How to celebrate the Cherry Blossom Festival', 'Why cherry trees are important to Japan', 'The benefits of cherry trees for the US'], a: 0, explain: 'The entire talk traces the history of how cherry blossom trees came to Washington DC from Japan. The topic is the arrival and origin story of the trees.' },
    ],
  },
]
...
export const LISTENING_IELTS = [
  {
    ...
    qs: [
      ...
      { q: "Q3. Postcode", type:'fill', a:['BS8 9PU', 'BS89PU'] },
      { q: "Q4. Container width", type:'fill', a:['0.75M', '0.75'] },
      { q: "Q5. Container height", type:'fill', a:['0.5M', '0.5'] },
      { q: "Q6. Second item in contents (after clothes)", type:'fill', a:'BOOKS' },
      { q: "Q7. Third item in contents", type:'fill', a:'TOYS' },
      { q: "Q8. Total estimated value (£)", type:'fill', a:['1700', '£1700'] },
  ...
  },
  {
    ...
    qs: [
      ...
      { q: "Q16. Second place to find information about community activities:", type:'fill', a:['(PUBLIC) LIBRARY', 'PUBLIC LIBRARY', 'LIBRARY'] },
    ]
  },
  {
    id: 'li3',
...
export const LISTENING_CAM17_T1 = [
  {
    ...
    qs: [
      ...
      { q: "Q10. Woodwork session cost (no camping): £___", type:'fill', a:['35', '£35'] },
    ]
  },
  {
...
export const LISTENING_CAM17_T3 = [
  {
    ...
    qs: [
      ...
      { q: "Q9. Daily hire rate (euros, before weekly discount):", type:'fill', a:['30', '€30'] },
